...
const agentFactory = require('./agent3/agentFactory.js')

//Actions
var makeNewTally = require("./agent3/actions/makeNewTally.js") 
...
module.exports = class AgentCluster {
  ...
  notifyTryTally(agentData, queryResponseVal) {
    // makeNewTally(agentData, this.#params, this.#worldDBManager, this.#myChipsDBManager, this.checkPeer, this.remoteCall, this.#logger)
  ...
  process(run) {
    ...
    let aData = this.#allAgents.get("p100" + this.#currAgent), //Point to agent's data // TODO: this makes aData undefined
